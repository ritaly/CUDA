...
cudaError_t addWithCuda(int *c, const int *a, const int *b, unsigned int size)
{
	...
	addKernel <<<1, size >> >(dev_c, dev_a, dev_b); // jaka struktura blokow - 1: blok jest 1, size u nas = 5 czyli tworzymy blok 5 watkowy i pozostale 27 bedzie nic nei robilo 
